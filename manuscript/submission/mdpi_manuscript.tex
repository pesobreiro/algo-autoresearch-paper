...
\supplementary{The following supporting information can be downloaded at: \linksupplementary{s1}, Table S1: Feature catalog with timeframe restrictions and normalization bounds for all leakage-free technical indicators used by the pipeline; Table S2: Inter-season design decisions documenting the rationale for major changes to acceptance gates and scoring across the twelve experimental seasons.}
