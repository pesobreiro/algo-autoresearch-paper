...
| S11 → S12 | S11 succeeded on BNB; test cross-asset generalisation | Switch to BTC/USDC; train 2017–2020, val 2021–2023, holdout 2024–2025; relax holdout gate to 0.3 | Verify asset-agnostic design on a different volatility regime |

*Note: Decisions were made by the human reviewer after each season based on the distribution of accepted strategies, failure modes, and holdout behaviour. Each transition typically required 15–30 minutes of review.*
