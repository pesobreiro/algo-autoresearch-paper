...
# ÚNICO FICHEIRO MODIFICADO PELO AGENTE
# REGRA CRÍTICA: APENAS INDICADORES RELATIVOS (sem preços absolutos)
#
# TEMPORADA 12 — MODO EXPLOIT: iter 8942 (score=0.93, sv=1.25, sh=0.67)
# Melhor equity OOS: 2024=€684, 2025=€630
# Bounds ±35% em torno de SL=7.431, TP=9.748, THR=0.876

# --- Features a usar no treino ---
...
# --- Otimização Bayesiana XGBoost (Optuna) ---
N_TRIALS_XGB = 0

# --- Otimização Bayesiana SL/TP/Threshold ---
